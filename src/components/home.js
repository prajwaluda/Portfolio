...
export const Home = () => {
  ...
  return (
    <Box p="5rem 15rem" textAlign="left" sx={{height:"100%"}}>
      ...
      <Box margin="50px 0px">
        ...
        <Box display={"flex"} gap={"30px"} alignItems={"center"} justifyContent={"space-around"}>
          <Card
            sx={{ border:"2px solid #132240", background:"none",width:"50%"}}
          >
              <CardContent>
      ...
      <Box margin="50px 0px">
        ...
        <Card
          ...
          >
              <CardContent>
                <CardActionArea sx={{p:"5px",borderRadius:"5px",display:"flex",justifyContent:"space-between"}}>
                    <Typography gutterBottom variant='h3'>Hypersage Technologies Pvt Ltd</Typography>
                    <Typography gutterBottom variant='h5'>Feb/2024 - Jun/2024</Typography>
                </CardActionArea>
